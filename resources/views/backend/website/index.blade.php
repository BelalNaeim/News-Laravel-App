            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="template-demo">
                        <a href="{{ route('add.website') }}"><button type="button" class="btn btn-primary btn-fw"
                                style="float: right;">Add Website Link</button></a>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($website as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('edit.website', $row->id) }}"
                                                class="btn btn-info">Edit</a>
                                            <a href="{{ route('delete.website', $row->id) }}"
