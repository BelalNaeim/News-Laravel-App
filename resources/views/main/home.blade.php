            ...
            <div class="row">
                                    ...
                                    <h4 class="lead-heading-01">
                                        <a href="{{ URL::to('view/post/' . $firstsectionbig->id) }}">
                                            @if (session()->get('lang') == 'english')
                                                {{ str_limit($firstsectionbig->title_en, 100) }}
                                            @else
                                                {{ str_limit($firstsectionbig->title_ar, 100) }}
                                            @endif
                                        </a>
                                    </h4>
                                </div>
                            ...
                            <div class="col-md-3 col-sm-3">
                                <div class="top-news">
                                    ...
                                    <h4 class="heading-02"><a href="{{ URL::to('view/post/' . $row->id) }}">
                                            @if (session()->get('lang') == 'english')
                                                {{ str_limit($row->title_en, 25) }}
                                            @else
                                                {{ str_limit($row->title_ar, 25) }}
                                            @endif
                                        </a>
                                    </h4>
                                </div>
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            @php
                                $vertical = DB::table('advertisments')
                                    ->where('type', 1)
                                    ->first();
                            @endphp
                        ...
                        <div class="photo">
                            <div class="embed-responsive embed-responsive-16by9 embed-responsive-item"
                                ...
                                <iframe width="560" height="315"
                                    src="https://www.youtube.com/embed/{{ $livetv->embeded_code }}" frameborder="0"
                    ...
                    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v13.0"
                                        nonce="YVuHN0yG"></script>

                    <div class="fb-page" data-href="https://www.facebook.com/Dev-Belal_Naeim-102833515729114"
                        data-tabs="" data-width="270" data-height="" data-small-header="false"
                        data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true">
                        <blockquote cite="https://www.facebook.com/Dev-Belal_Naeim-102833515729114"
                            class="fb-xfbml-parse-ignore"><a
                                href="https://www.facebook.com/Dev-Belal_Naeim-102833515729114">Dev : Belal_Naeim</a>
                        </blockquote>
                    </div>
            ...
            <div class="row">
                <div class="col-md-9 col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="sidebar-add">
                                <img src="{{ asset('frontend/assets/img/banner-ad2-728x90.jpeg') }}" alt="" />
                            </div>
                        </div>
                    </div><!-- /.add-close -->
                ...
                <div class="col-md-3 col-sm-3">
                    ...
                    @php
                        $prayertime = DB::table('prayers')->first();
                    @endphp
                    <!-- Namaj Times -->
                                ...
                                <div class="myVideos" style="width:100%">
                                    <div class="embed-responsive embed-responsive-16by9 embed-responsive-item">
                                        <iframe width="853" height="480"
                                            src="https://www.youtube.com/embed/{{ $videobig->embded_code }}"
                                            frameborder="0"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="gallery_sec owl-carousel">
                                @foreach ($videosamll as $row)
                                    <div class="embed-responsive embed-responsive-16by9 embed-responsive-item">
                                        <iframe width="853" height="480"
                                            src="https://www.youtube.com/embed/{{ $row->embded_code }}" frameborder="0"
                                            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                    </div>
                                @endforeach
